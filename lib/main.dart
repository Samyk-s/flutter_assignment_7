...
class ProfileScreen extends StatelessWidget {
  ...
  TextSpan(
   // default text style
    children: <TextSpan>[
      TextSpan(text: '      Samyak Bajracharya\n', style: TextStyle(fontStyle: FontStyle.italic)),
      TextSpan(text: '\n Kyc unverified  '),
      TextSpan(text: 'Verify now', style: TextStyle(fontWeight: FontWeight.bold)),
            ...
            itemProfile('Wallet', 'you have not verify kyc', CupertinoIcons.money_dollar),
            const SizedBox(height: 10),
            itemProfile('Booking History', ' ', CupertinoIcons.clock),
            const SizedBox(height: 10),
             itemProfile('Favorite Destination', ' ', CupertinoIcons.paperplane_fill),
             const SizedBox(height: 10,),
